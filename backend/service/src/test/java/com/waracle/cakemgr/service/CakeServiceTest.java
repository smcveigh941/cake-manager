...
public class CakeServiceTest {
  ...
  public void testGetCakesReturnsListOfEntitiesFromRepository() {
    ...
    List<CakeEntity> cakeEntities = cakeService.getCakes();

    assertThat(cakeEntities.size()).isEqualTo(2);
    assertThat(cakeEntities.get(0)).isEqualTo(cakeEntity1);
    assertThat(cakeEntities.get(1)).isEqualTo(cakeEntity2);
  }
