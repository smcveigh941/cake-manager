...
class CakeResourceTest {
  ...
  @InjectMocks
  private CakeResource cakeResource;
  ...
  void testGetReturnsListOfCakes() {
    ...
    ResponseEntity<List<CakeResponseDto>> response = cakeResource.getCakes();
  ...
  void testPostSucceedsWithOkResponse() {
    ...
    ResponseEntity<String> response = cakeResource.postCake(cakeRequestDto);
